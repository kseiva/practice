...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'library_booksimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('small_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('large_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('img_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('link_book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['library.Book'])),
    ...
    models = {
        ...
        u'library.booksimage': {
            ...
            'cont_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'large_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'link_book': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['library.Book']"}),
            'small_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'})
        },
        u'library.publisher': {
